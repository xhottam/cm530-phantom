...
#--specs=rdimon.specs / --specs=nosys.specs
#https://ww1.microchip.com/downloads/en/DeviceDoc/Frequently-Asked-Questions-4.9.3.26.txt
#https://stackoverflow.com/questions/79923/what-and-where-are-the-stack-and-heap
#https://github.com/ROBOTIS-GIT/OpenCM9.04/blob/d686caa5bfccd25468646ec10d6b3afb26d68206/arduino/opencm_arduino/opencm9.04/variants/OpenCM904/bsp/opencm/ldscript/opencm_flash.ld
LDFLAGS = -Wl,--print-memory-usage,--gc-sections,-Map=$@.map,-cref,-u,Reset_Handler $(INCLUDE_DIRS) $(LIBRARY_DIRS) -T stm32.ld 
